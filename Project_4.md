...
then run the command below to upgrade ubuntu repository

`sudo apt upgrade`

Add certificates by running the command below, you can  run it separately or together, the result is still the same
...
Use the code below to install NodeJS
...
- Run the code below too Install MongoDB

`sudo apt install -y mongodb`

- You need to start the server and make sure the server is  active and running. run the command below to start the service.

`sudo service mongodb start`

-  Verify that the service is up and running with the command below

`sudo systemctl status mongodb`

![Image](./Images/sudo_systemctl_status_mongodb.png)
...
![Images](./Images/node_server_js.png)
